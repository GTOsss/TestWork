...
const Input = ({
  input: { value, onChange }, meta: { touched, error }, placeholder, setRef, cssInput,
  cssTypeGroup, cssWidth, defaultValue, readOnly, onBlur, onFocus, onChange: onChangeHandler,
}) => (
  <div
