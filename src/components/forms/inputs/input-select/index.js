...
const Select = ({
  input: { onChange, value }, meta: { touched, error }, defaultValue, options, className,
  placeholder, isLoading, noResultsText, loadOptions, searchPromptText, loadingPlaceholder,
  cssTypeGroup, cssWidth, cssBorderNone,
}) => (
  <div
